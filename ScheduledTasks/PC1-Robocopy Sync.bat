:: Sync Autoit Startup Automation Scripts
...
ROBOCOPY "D:\GitHub\personal\StartupScripts\AutoHotkeyScripts\Overall" "D:\GoogleDrive\Personal Sync\Scripts-AutoHotKey"  /MIR /R:x /W:x